...
const CandidatesListSidebarData = () => {
 ...
 useEffect(()=>{
  //  const handleSearchJobTitle=()=>{
   ...
   if( experienced!== "none")  params.set("experienced",experienced) ; else params.delete("experienced");
  ...
  return (
    ...
    <div className='flex flex-col w-full space-y-7 p-4 rounded-md bg-slate-100'>
      ...
      <div className="flex items-center space-x-2">
        <Switch id="2-year" checked={qualification === "bacgelor-degree"} onCheckedChange={() => handleQualification("bacgelor-degree")} />
        <Label htmlFor="2-year">Bachelor Degree</Label>
      </div>

      <div className="flex items-center space-x-2">
        <Switch id="3-year" checked={qualification === "master-degree"} onCheckedChange={() => handleQualification("master-degree")} />
        <Label htmlFor="3-year">Master’s Degree</Label>
      </div>

      <div className="flex items-center space-x-2">
        <Switch id="4-year" checked={qualification === "doctorate-degree"} onCheckedChange={() => handleQualification("doctoratedegree")} />
        <Label htmlFor="4-year">Doctorate Degree</Label>
      </div>
                        </div>
                             </div>
